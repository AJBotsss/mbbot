...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('𝐌𝐨𝐯𝐢𝐞𝐬 𝐆𝐫𝐨𝐮𝐩', url='https://t.me/+lULqM33QsWMxNThl'),
            InlineKeyboardButton('𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url='https://t.me/MZ_OFCL')
        ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('👥 ɢʀᴏᴜᴘ sᴇᴛᴛɪɴɢ 🫂', callback_data=f"setting")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
